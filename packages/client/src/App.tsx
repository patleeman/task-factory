...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50">
      {/* Header */}
      <header className="flex items-center justify-between px-3 lg:px-4 py-3 bg-slate-900 text-white shadow-lg">
        <div className="flex items-center gap-2 lg:gap-4 min-w-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <h1 className="text-lg font-bold tracking-tight hidden sm:block">PI-FACTORY</h1>
          </div>
        ...
        <div className="flex items-center gap-2 lg:gap-3 shrink-0">
          ...
          {isConnected ? (
            ...
            <span className="flex items-center gap-1.5 text-xs text-slate-400" title="Offline">
              <span className="w-2 h-2 bg-slate-400 rounded-full" />
              <span className="hidden sm:inline">Offline</span>
            </span>
          )}
          
          {/* Config buttons - Icon only */}
          {currentWorkspace && (
            <button
          ...
          <button
            ...
            className="btn btn-primary text-sm py-1.5 px-2 sm:px-3 flex items-center gap-1"
          >
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div className="flex-1 overflow-hidden">
          <KanbanBoard
            ...
            activity={activity}
            onActivityTaskClick={setSelectedTask}
            onSendMessage={handleSendMessage}
          />
        </div>

        {/* Activity Log Sidebar - Desktop Only */}
        <div className="hidden lg:block w-[380px] flex-shrink-0 border-l border-slate-200">
          <ActivityLog
            entries={activity}
            onTaskClick={setSelectedTask}
            onSendMessage={handleSendMessage}
